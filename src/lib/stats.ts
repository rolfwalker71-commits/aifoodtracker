...
export async function getStatsForUser(userId: string, range: StatsRange) {
  ...
  return {
    ...
    averages: {
      ...
      saturatedFat: totals.saturatedFat / dayCount,
      sodium: totals.sodium / dayCount,
      potassium: totals.potassium / dayCount,
      vitaminA: totals.vitaminA / dayCount,
      vitaminC: totals.vitaminC / dayCount,
      vitaminD: totals.vitaminD / dayCount,
    ...
    goals: {
      ...
      dailyVitaminAGoal: user.dailyVitaminAGoal,
      dailyVitaminCGoal: user.dailyVitaminCGoal,
      dailyVitaminDGoal: user.dailyVitaminDGoal,
      dailyCalciumGoal: user.dailyCalciumGoal,
      dailyIronGoal: user.dailyIronGoal,
    },
    series: daySeries,
